Working with data structure and algorithms
...
* [anuth Sequence](./100-shell_sort.c)
...
### [10. Bitonic sort](./106-bitohat-is-the-time-complexity-of-indexing-inserting-and-removing-from-common-d.com/developers/sorting-algorithms)
...
* [Big O notatnálisis de la complejidad de los algoritmos](https://www.cs.us.es/~jalonso/cursos/i1m/temas/tema-28.html)
...
* [Big-O is easy to calculate, if you know how](https://justin.abrah.ms/computer-science/how-to-calte a function that sorts a deck of cards.

---

## Author
* **Azeez Olarewaju Lawal**
lgorithm - What is a plain English explanation of "Big O" notation?](https://stackoverflow.comotation)
* [What is the time complexity of indexing, inserting and removing from common data structures?](https://stackoverflow.com/questions/122799/wculate-big-o.html)
...
Big O notation, and how to evaluate the time complem for a given input
* What is a stable sorting algorithm

---

### [0. Bubble sort](./0-bubble_sort.c)
* Write a function that sorts an arrhm


### [1. Insertion sort](./1-insertion_sort_list.c)
* Write a function that sorts a doubly linked list of integers in ascending order using the Insertioort.c)
* Write a function that sorts an array of integers in ascending order using the Selection sort te a function that sorts an array of integers in ascending order using the Quick sort algorithm


### [4. Shell sort - Knic_sort.c)
